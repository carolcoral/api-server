...
public class MockService {
    ...
    public void clearCustomResponseCache() {
        ...
        com.carolcoral.apiserver.plugin.DynamicCompiler.clearAllCaches();
     ...
     * 检查参数值在请求中是否实际存在
     */
    private boolean paramValueExistsInRequest(com.carolcoral.apiserver.dto.ResponseRequestParamDTO param,
     ...
     * @return 是否匹配
     */
    private boolean matchRequestParam(com.carolcoral.apiserver.dto.ResponseRequestParamDTO param,
                                   MockRequest mockRequest) {
        try {
            ResponseRequestParam.ParamType paramType = ResponseRequestParam.ParamType.valueOf(param.getParamType());
