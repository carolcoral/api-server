...
import com.carolcoral.apiserver.service.ProjectExportService;
...
public class ProjectExportController {
     ...
     */
    @Operation(summary = "导出项目Swagger", description = "导出项目 API 为 Swagger/OpenAPI 格式")
    @PreAuthorize("hasRole('ADMIN') or hasAuthority('project:export_swagger')")
     ...
     */
    @Operation(summary = "导出项目数据", description = "导出项目完整数据为 JSON 格式")
    @PreAuthorize("hasRole('ADMIN') or hasAuthority('project:export_data')")
     ...
     */
    @Operation(summary = "导入项目数据", description = "从 JSON 文件导入项目数据到已有项目")
    @PreAuthorize("hasRole('ADMIN') or hasAuthority('project:import_data')")
     ...
     */
    @Operation(summary = "导入项目数据（自动创建）", description = "从 JSON 文件导入项目数据，自动创建项目")
    @PreAuthorize("hasRole('ADMIN') or hasAuthority('project:import_data')")
