...
import com.carolcoral.apiserver.service.CustomUserDetailsService;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    private static final String MOCK_SERVER_PATH_PREFIX = "/api-server/";
    ...
    private boolean isPublicPath(String requestUri) {
        ...
        if (requestUri.equals("/") ||
            ...
            requestUri.equals("/statistics") || requestUri.equals("/debug-panel") ||
        ...
        // AI 代理接口（OpenAI兼容）- 通过 API Key 鉴权，不由 JWT 处理
        if (requestUri.startsWith("/api/ai/v1/")) {
            return true;
        }
